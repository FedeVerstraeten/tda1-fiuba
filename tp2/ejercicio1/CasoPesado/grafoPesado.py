    ...
    def __init__(self):
        ...
        for l in fichero:
            ...
            if indice == 1:
                ...
                #print("")
                peso = calcularDistancia(self.grafoNodos[indice].nodoPosicionX,self.grafoNodos[indice].nodoPosicionY,self.grafoNodos[indice-1].nodoPosicionX,self.grafoNodos[indice-1].nodoPosicionY)
                ...
                if len(nodosExistentes) == 0:
                    ...
                    if  len(nodosExistentes) == 1:
                        if nodosExistentes[0].nodoPosicionX == num(campos[0]) and nodosExistentes[0].nodoPosicionY == num(campos[1]):#aca a veces anda y a veces no :/
                            self.grafoNodos[indice] = nodo(campos[3],campos[4],indice+1)
                            peso = calcularDistancia(self.grafoNodos[indice].nodoPosicionX,self.grafoNodos[indice].nodoPosicionY,nodosExistentes[0].nodoPosicionX,nodosExistentes[0].nodoPosicionY)
                    ...
                    if len(nodosExistentes) == 2:
                        peso = calcularDistancia(nodosExistentes[1].nodoPosicionX,nodosExistentes[1].nodoPosicionY,nodosExistentes[0].nodoPosicionX,nodosExistentes[0].nodoPosicionY)
